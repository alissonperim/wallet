...
export class InitialMigration1698235101130 implements MigrationInterface {
    name = 'InitialMigration1698235101130'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."card_types_enum" AS ENUM('credit_card', 'debit_card', 'alimentation_card')`);
        await queryRunner.query(`CREATE TABLE "card" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "identifier" character varying NOT NULL, "last_digits" character varying NOT NULL, "types" "public"."card_types_enum" NOT NULL, "dueDay" date, "walletId" character varying, CONSTRAINT "PK_9451069b6f1199730791a7f4ae4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5519368bd6c895ee797c491437" ON "card" ("walletId") `);
        await queryRunner.query(`CREATE TABLE "wallet" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "amount" numeric NOT NULL, CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying(120) NOT NULL, "walletId" character varying, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_922e8c1d396025973ec81e2a40" UNIQUE ("walletId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e12875dfb3b1d92d7d7c5377e2" ON "user" ("email") `);
        await queryRunner.query(`CREATE TABLE "category" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "name" character varying NOT NULL, "estimated_expense_per_month" numeric NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."installments_installment_status_enum" AS ENUM('pending', 'paid')`);
        await queryRunner.query(`CREATE TABLE "installments" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "amount" numeric NOT NULL, "installments" integer NOT NULL, "installment" integer NOT NULL, "installment_status" "public"."installments_installment_status_enum" NOT NULL, "payment_date" date NOT NULL, "cardId" character varying, CONSTRAINT "PK_c74e44aa06bdebef2af0a93da1b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "expense" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.608Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2023-10-25T11:58:25.609Z"', "description" character varying NOT NULL, "amount" numeric NOT NULL, "wallet_id" character varying NOT NULL, "type" "public"."expense_type_enum" NOT NULL, "installments" integer, "installment_status" "public"."expense_installment_status_enum" NOT NULL, "categoryId" character varying, CONSTRAINT "PK_edd925b450e13ea36197c9590fc" PRIMARY KEY ("id"))`);
